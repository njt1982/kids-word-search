    ...
    <div class="container">
      <div class="row mt-3">
        <div class="col-auto mt-1 mb-4 px-4 ps-sm-5 pe-sm-3 px-md-0 mx-auto" id="wordsearch_grid">
          <div class="d-flex justify-content-center" v-for="(rowV, row) in sizeInt" :key="row - 1">
            <div class="col border" v-for="(colV, col) in sizeInt" :key="`${row}_${col}`">
              <div
        ...
        <div class="col mb-5">
          <h2>Words</h2>
          <div class="words">
            <span v-for="word in usedWords" :key="word" :class="wordListClasses(word)">{{
              word
            }}</span>
          </div>
          ...
          <div class="btn btn-primary mb-2 d-block" @click="rebuildGrid()">New Game</div>
          <div class="btn btn-primary mb-2 d-block" @click="clearGameState()">
            Restart this game
          </div>
        </div>
      </div>
            ...
            <form>
              <div class="row mb-2">
                ...
                <div class="form-group form-inline col-8 row">
                  ...
                  >
                    <input v-model.lazy="words[index]" type="text" class="form-control" />
                    <div class="btn btn-outline-danger border-light" @click="removeWord(index)">
                      -
                    </div>
                  </div>

                  <div class="mb-2 col">
                    <div class="btn btn-success btn-sm" @click="addWord()">Add Word</div>
                  </div>
                </div>
              </div>

              <div class="row mb-2">
                <label for="size-settings" class="col-4">Grid Size:</label>
                <div class="col">
                  <input
                    id="size-settings"
                    v-model.lazy="size"
              ...
              <div class="row mb-2">
                <label class="col-4 form-check-label" for="backwards-settings"
